...
def prepare_surface(parameters, h5_filename='Connectivity_nuria_v1.h5', zip_filename= 'Cortex.zip', vertices_to_region_filename = 'vertices_to_region.npy', region_map_filename = 'region_map.txt'):
    import os
