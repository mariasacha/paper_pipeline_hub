...
#
np.save(f'{save_path}data/ExpTF_{Npts_e}x{Npts_i}_{save_name}_{CELLS}.npy', FRout_inh)
np.save(f'{save_path}data/{Npts_e}x{Npts_i}_{save_name}_{CELLS}_adapt.npy', Adapt)

np.save(f'{save_path}data/{Npts_e}x{Npts_i}_{save_name}_{CELLS}_muv.npy', muvi)
...
np.save(f'{save_path}data/{Npts_e}x{Npts_i}_{save_name}_{CELLS}_params.npy', np.array([Fe_eff, range_inh, params], dtype='object'), allow_pickle=True)
