...
def plot_ntwk_sim_output_for_waveform(args,\
    ...
    #first figure the one with the raster plot
    ...
    #second figure for exc
    #Membrane potential time courses of of three excitatory cells (green, top) and three inhibitory cells (red, bottom) with the pre- diction of the mean and standard deviation in time.
    ...
    #fourth figure
    #Population activity (in 5 ms bins) of the excita- tory (green) and inhibitory (red) sub-populations. Superimposed is the mean and standard deviation over time predicted by the Markovian formalism. We also show the applied external stimulation (νaff e (t),dotted line).
